...
from utils.utils import sell_product_by_product_name, get_path_to_directory_of_file

directory_of_testcase = "fn_sell_product_with_product_name_testcases" 
...
def test_01_sell_1_product_by_product_name_happy_flow():
    filecmp.clear_cache()
    sell_product_by_product_name("chicken", 4.6,"2023-10-10", path_to_file_sold_csv_test_01, path_to_file_with_actual_result_test_01, path_to_file_bought_csv_test_01)
...
def test_02_sell_2_products_by_product_name_happy_flow():
    filecmp.clear_cache()
    sell_product_by_product_name("milk", 7.5,"2023-10-15", path_to_file_sold_csv_test_02, path_to_file_with_actual_result_test_02, path_to_file_bought_csv_test_02)
    sell_product_by_product_name("milk", 15.6,"2023-10-17", path_to_file_with_actual_result_test_02, path_to_file_with_actual_result_test_02, path_to_file_bought_csv_test_02)
