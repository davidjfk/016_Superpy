...
from utils.utils import calculate_expired_products, get_path_to_directory_of_file

directory_of_testcase = "fn_calculate_expired_products" 
...
def test_01_calculate_expired_products():
    filecmp.clear_cache()
    ...
    actual_result = calculate_expired_products(date_on_which_to_calculate_expired_products, path_to_input_file_sold_test_01,
    path_to_input_file_cost_test_01)
    assert actual_result == expected_test_result


def test_02_calculate_expired_products():
    filecmp.clear_cache()
    ...
    actual_result = calculate_expired_products(date_on_which_to_calculate_expired_products, path_to_input_file_sold_test_02,
