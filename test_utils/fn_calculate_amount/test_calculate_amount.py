...
from utils.utils import calculate_amount, get_path_to_directory_of_file

directory_of_testcase = "fn_calculate_amount" 
...
def test_01_calculate_amount_happy_flow():
    filecmp.clear_cache()
    start_date = "2023-10-04"
    end_date = "2023-10-16"
    expected_test_result = 28.1
    actual_result = calculate_amount(start_date, end_date, "buy_date", "buy_price", path_to_input_file_test_01)
    assert actual_result == expected_test_result


def test_02_calculate_amount_happy_flow():
    filecmp.clear_cache()
    start_date = "2023-10-15"
    end_date = "2023-10-27"
    expected_test_result = 25.5
    actual_result = calculate_amount(start_date, end_date, "buy_date", "buy_price", path_to_input_file_test_02)
    assert actual_result == expected_test_result
