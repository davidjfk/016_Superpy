...
def test_01_calculate_expired_products_on_day_happy_flow():
    ...
    actual_result = calculate_expired_products_on_day(date_on_which_to_calculate_expired_products, path_to_input_file_revenue_test_01,
...
def test_02_calculate_expired_products_on_day_happy_flow():
    ...
    actual_result = calculate_expired_products_on_day(date_on_which_to_calculate_expired_products, path_to_input_file_revenue_test_02,
