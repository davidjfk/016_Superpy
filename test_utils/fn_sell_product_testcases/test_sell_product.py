...
def test_02_sell_2_products_happy_flow():
    filecmp.clear_cache()
    sell_product("b_1", 7.5,"2023-10-06", path_to_input_file_test_02, path_to_file_with_actual_result_test_02)
    sell_product("b_3", 15.6,"2023-10-14", path_to_file_with_actual_result_test_02, path_to_file_with_actual_result_test_02)
