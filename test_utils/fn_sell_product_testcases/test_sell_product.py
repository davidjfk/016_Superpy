...
from utils.utils import sell_product, get_path_to_directory_of_file
...
def test_01_sell_1_product_happy_flow():
    filecmp.clear_cache()
    sell_product("b_2", 4.6,"2023-10-10", path_to_file_sold_csv_test_01, path_to_file_with_actual_result_test_01, path_to_file_bought_csv_test_01)
...
def test_02_sell_2_products_happy_flow():
    filecmp.clear_cache()
    sell_product("b_1", 7.5,"2023-10-06", path_to_file_sold_csv_test_02, path_to_file_with_actual_result_test_02, path_to_file_bought_csv_test_02)
    sell_product("b_3", 15.6,"2023-10-14", path_to_file_with_actual_result_test_02, path_to_file_with_actual_result_test_02, path_to_file_bought_csv_test_02)
