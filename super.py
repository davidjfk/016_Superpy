...
def main():
    ...
    '''
    pitfall / for future reference: do not (try to) assign a default value to the following 3 variables at this location:
    ...
    %Y-%m-%d can be either 2021-01-01 or 21-01-01. Problem: the 2nd notation is ambiguous: Jan 1st 2021, or Jan 21st 2001? 
    To the user it is not obvious / intuitive what the notation is required. So I will not allow the 2nd notation.
    '''
    class ValidDate(argparse.Action):
        def __call__(self, parser, namespace, values, option_string=None):    
            ...
            try:
                ...
                However, for 'does not expire' no conversion is needed, so this try block won't (nor need to) catch it.
                '''
            except ValueError:
