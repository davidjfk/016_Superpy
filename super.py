...
def main():
    ...
    # EXPIRED_PRODUCTS: create subparser "show_expired_products" with help text and add it to the container "command":
    ...
    subparser_buy_product.add_argument("-date", "-d", default=get_system_date(path_to_system_date), type=str, help="date in following format: '%Y-%m-%d'. ex: 2026-10-21 ") 

    # INVENTORY: create subparser "show_inventory" with help text and add it to the container "command":
    ...
    # start_date = '2023-09-01'
    # end_date = '2023-12-21'
    # sales_volume = calculate_sales_volume_in_time_range_between_start_date_and_end_date_inclusive(start_date, end_date, path_to_csv_sold_file)
    # print(f"Sales volume in number of products: {sales_volume}")
